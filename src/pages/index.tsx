    ...
    <Layout>
      ...
      <main className=" flex flex-col items-center justify-center pb-10">
        ...
        <div className="flex flex-col items-center xl:flex-row max-w-7xl w-full gap-x-10">
          ...
          {/* Create TASK Column */}
          <div className="md:flex-1 w-full overflow-x-hidden shadow-xl rounded-lg mt-10 p-10 flex flex-col items-center overflow-y-auto font-quicksand md:max-h-[683px]">
